...
const Select = ({ arrayOfOptions, id, isError, onChange, labelTitle, className, wrapperClassName, placeholderOption, selected, name, multiple, disabled }) => {
    ...
    return (
        <div className={`${wrapperClassName} form-floating mb-3 `}>
            <select
                className={`${isInputError} ${noLabel} ${className} transparentBG select form-select`}
                multiple={multiple}
